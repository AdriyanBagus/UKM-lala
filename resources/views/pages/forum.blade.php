                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <div class="forum-thread mb-4">
                        ...
                        <div class="thread-item mb-3">
                            ...
                            <p class="thread-meta">Dibuat oleh <b>John Doe</b> pada 27 Nov 2024 | 10 komentar</p>
                        </div>
                        <div class="thread-item mb-3">
                            <a href="#" class="thread-title">Pengalaman bergabung dengan UKM seni</a>
                            <p class="thread-meta">Dibuat oleh <b>Jane Smith</b> pada 26 Nov 2024 | 5 komentar</p>
                        </div>
                        <div class="thread-item">
                            <a href="#" class="thread-title">Apakah UKM olahraga cocok untuk pemula?</a>
                            <p class="thread-meta">Dibuat oleh <b>Michael</b> pada 25 Nov 2024 | 8 komentar</p>
                        </div>
                    </div>
                    ...
                    <div class="forum-thread comment-section">
                        <h4>Komentar</h4>
                        <div class="comment">
                            <p><b>Alice:</b> Saya juga bingung memilih UKM, ada saran?</p>
                        </div>
                        <div class="comment">
                            <p><b>Bob:</b> Pilih UKM yang sesuai dengan minatmu, pasti lebih seru!</p>
                        </div>
                        <div class="comment">
                            <p><b>Charlie:</b> Kalau belum yakin, coba ikut trial dulu.</p>
                        </div>
                        <!-- Comment Form -->
                        <form class="mt-4">
                            <div class="mb-3">
